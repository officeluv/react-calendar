...
function (_Component) {
  ...
  function Tile(props) {
    ...
    _this.state = {
      // eslint-disable-line
      tileClassName: typeof tileClassName === 'function' ? tileClassName({
        date: date,
        view: view
      }) : tileClassName,
      tileClassNameProps: tileClassName,
      tileContent: typeof tileContent === 'function' ? tileContent({
        date: date,
        view: view
      }) : tileContent,
  ...
  _createClass(Tile, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      var _this$state = this.state,
          tileClassNameProps = _this$state.tileClassNameProps,
          tileContentProps = _this$state.tileContentProps;
    ...
    value: function render() {
      ...
      var _this$state2 = this.state,
          tileClassName = _this$state2.tileClassName,
          tileContent = _this$state2.tileContent;
